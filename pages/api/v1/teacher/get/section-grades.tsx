...
import { fetchSectionStudentGrades } from "@/helpers/teacher/Students";
...
export default async function handler(
    ...
    try {
        ...
        const response = await fetchSectionStudentGrades(sectionId!, gradeLevel, section, academicYear)

...
import { capitalize, generateAddress, generateBirthdate, generateContact, generateFullname, generateGrade, generatePassword, generateReligion, generateSex, generateStudentEmail, generateLRN } from '@/utils/feeds';
